    ...
    lessons: [
      ...
      { title: "Own something real", meet: ["aapl", "nke", "pfe"], prepay: true, items: [
        ...
        { type: "choice", q: "You just became",
          options: ["A shareholder", "A customer", "A lender"], answer: 0,
          right: "Shareholder.",
          wrong: "A shareholder. You own a small piece of the company." },
      ]},
      ...
      { title: "Time beats timing", meet: ["mcd"], items: [
        ...
        { type: "choice", q: "Which picture matters to a shareholder?",
      ...
      { title: "What you pay for what it earns", meet: ["xom", "jnj"], items: [
        ...
        { type: "dollar", q: "$100 comes in. Tap the shareholders' money.",
          rows: [["Workers", "$38"], ["Suppliers", "$30"], ["The bank", "$8"], ["Taxes", "$12"], ["You, the shareholders", "$12"]], answer: 4,
          right: "What's left is profit.",
          wrong: "Everyone else gets paid first. Shareholders keep what is left." },
