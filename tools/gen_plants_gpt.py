...
OUT = pathlib.Path(__file__).resolve().parent.parent / "public" / "sprites" / "gpt" / "plants"
...
SPRITES = {
    "plant-pumpkin": "One ripe orange pumpkin sitting among its green vine leaves, a compact pumpkin plant.",
    "plant-tomato":  "One leafy tomato plant on a small stake, heavy with ripe red tomatoes.",
    "plant-corn":    "One tall green corn stalk with two golden ears of corn and long leaves.",
    "plant-berry":   "One round blueberry bush covered in clusters of ripe blue berries.",
}
